		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ESG Survey",
									"targetURL": "#bragrfsesgsurvey-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bragrfsesgsurvey-display": {
								"semanticObject": "bragrfsesgsurvey",
								"action": "display",
								"description": "ESG Survey",
								"title": "ESG Survey",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.agr.fs.esgsurvey",
									"url": sap.ui.require.toUrl("br/agr/fs/esgsurvey")
								}
							}
						}
					}
